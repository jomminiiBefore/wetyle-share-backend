# Generated by Django 3.0.3 on 2020-03-04 04:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('brand', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='brands', to='product.Brand')),
        ...
        migrations.AddField(
            model_name='product',
            name='product_like',
            field=models.ManyToManyField(through='product.ProductLike', to='user.User'),
        ),
        migrations.AddField(
            model_name='product',
            name='product_size',
